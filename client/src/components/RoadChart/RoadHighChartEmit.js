...
const query = `
  query Emitters {
    LMaxHighEmitters: roadclassification(where: {datetime: {_gte: "2022-01-01 00:00:00", _lte: "2022-02-21 23:59:59"}, sound_classification: {_eq: "high"}, speed:{}}, order_by: {speed: asc}) {
      label: speed
      data: lmax
    }
  }
  ...
  >
    {({ data, error, loading }) => {
      ...
      options={{
        title:{
          display:true,
          text:'LMax Value of High Emitter - Vehicles',
          fontSize:20
        },
        showLines: false,
        scales:{
...
export default RoadHighChartEmit;
